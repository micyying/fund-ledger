...
目前版本：**GitHub版 · v1.3.0**（2026-09-26）。原「理財建議」頁改為「資料表」，包含基金持倉、銀行／平台彙總及每月資金進出；追蹤標的設定仍可從持倉表開啟。各幣種分開列示，缺少淨值的持倉不會被當成零盈虧。先前版本已修正手機日曆排版與資產估值問題。版本號顯示在頁面頂部；WorkBuddy 版不共用此版本號。
